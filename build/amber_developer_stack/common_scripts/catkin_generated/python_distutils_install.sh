...
echo_and_run cd "/home/xiaobin/cassie_ws/src/amber_developer_stack/common_scripts"
...
echo_and_run /usr/bin/env \
    ...
    "/home/xiaobin/cassie_ws/src/amber_developer_stack/common_scripts/setup.py" \
     \
    build --build-base "/home/xiaobin/cassie_ws/build/amber_developer_stack/common_scripts" \
    install \
    --root="${DESTDIR-/}" \
