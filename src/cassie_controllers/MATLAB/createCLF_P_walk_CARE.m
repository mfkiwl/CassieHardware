...
Q(4,4) = 390; % Stance leg length
Q(5,5) = 7150; % Swing leg length
Q(6,6) = 4056; % Swing leg angle
Q(7,7) = 1872; % Swing leg roll
Q(8,8) = 520;  % Swing leg yaw
Q(9,9) = 520;  % Swing foot pitch
% Q(1:9,1:9) = Q(1:9,1:9) * 1.3; 

Q(10,10) = 19.2;  % Roll
Q(11,11) = 7.3;  % Pitch
Q(12,12) = 1.6;  % Stance yaw
Q(13,13) = 1.6; % Stance leg length
Q(14,14) = 96;  % Swing leg length
Q(15,15) = 28.8;  % Swing leg angle
Q(16,16) = 18;  % Swing leg roll
Q(17,17) = 15;  % Swing leg yaw
Q(18,18) = 12;  % Swing foot pitch
